  ...
  return (
    <div className="min-h-screen bg-dark-charcoal py-12 px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        {/* Main Message */}
        <div className="mb-12">
          <h1 className="fade-club-heading text-4xl sm:text-5xl text-primary-gold mb-4">
            {isOneTime ? 'Booking Submitted!' : 'Welcome to FadeClub!'}
          </h1>
          <p className="text-gray-300 text-lg leading-relaxed max-w-xl mx-auto">
            Thanks, <span className="font-semibold text-primary-gold">{booking.client.name}</span>. 
        ...
        <div className="card-dark mb-8 text-left">
          <div className="text-center mb-6">
            <h3 className="fade-club-heading text-2xl text-primary-gold">
          ...
          <div className="grid gap-6">
            ...
            <div className="flex items-center justify-between p-4 bg-dark-gray rounded-lg">
              <div>
                ...
                <p className="font-semibold text-lg text-gray-100">{booking.service.name}</p>
              </div>
              <div className="text-right">
                <span className="text-2xl font-bold text-primary-gold">{priceText}</span>
                <p className="text-sm text-gray-400">{booking.service.duration} minutes</p>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <span className="text-sm text-gray-400 uppercase tracking-wide">Contact</span>
                <p className="font-medium">{booking.client.name}</p>
                <p className="text-sm text-gray-300">{booking.client.email}</p>
                <p className="text-sm text-gray-300">{booking.client.phone}</p>
              </div>
              
              {booking.client.isFirstTime && (
                <div className="flex items-center">
                  <div className="badge badge-accent">First Visit</div>
                  <span className="text-sm text-gray-300 ml-2">Extra consultation time included</span>
                </div>
              )}
            </div>
            ...
            {booking.preferredTimes && booking.preferredTimes.length > 0 && (
              <div>
                <span className="text-sm text-gray-400 uppercase tracking-wide">Your Preferred Times</span>
            ...
            {booking.client.notes && (
              <div>
                <span className="text-sm text-gray-400 uppercase tracking-wide">Style Notes</span>
                <p className="text-gray-300 mt-1 italic">&ldquo;{booking.client.notes}&rdquo;</p>
              </div>
            )}
          </div>
        </div>
        ...
        {/* Next Steps */}
        <div className="card-dark mb-8 bg-dark-gray">
          <h4 className="fade-club-heading text-xl text-primary-gold mb-4">What&apos;s Next?</h4>
          <div className="grid sm:grid-cols-2 gap-4 text-left">
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-6 h-6 bg-primary-gold rounded-full flex items-center justify-center">
                <span className="text-dark-charcoal text-xs font-bold">1</span>
              </div>
              <div>
                <p className="font-medium">Confirmation Call</p>
                <p className="text-sm text-gray-300">We&apos;ll call you within 24 hours to confirm your appointment</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-6 h-6 bg-primary-gold rounded-full flex items-center justify-center">
                <span className="text-dark-charcoal text-xs font-bold">2</span>
              </div>
              <div>
                <p className="font-medium">Your Visit</p>
                <p className="text-sm text-gray-300">Arrive 10 minutes early for your premium experience</p>
              </div>
            </div>
          </div>
        </div>
